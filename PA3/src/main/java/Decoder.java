...
/**
 *
 * Decoder takes encoded bit sequence and convert it to a String. Huffman Tree
 * is passed as arguments of the constructor.
 *
 * Decoding process 1. Start from the root of the Huffman Tree 2. Start from the
 * first bit of the bit sequence 3. If the bit is 0 follow the left child 4. If
 * the bit is 1 follow the right child 5. If a leaf node is reached, track the
